        ...
        >
          <div class="flex space-x-4 ...">
            <input
              ...
              type="text"
              placeholder="Enter a task or todo"
              ref={(node) => {
                input = node;
              }}
            ></input>
            ...
            {data.todos.map((todo) => (
              <li key={todo.id} className="w-100">
                <div class="flex space-x-4 ...">
                  ...
                  <button
                    className="inline-block px-6 py-2 border-2 border-red-600 text-red-600 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out float-right"
                    onClick={() => {
                  ...
                  <button
                    className={`btn inline-block px-6 py-2 border-2 border-yellow-500 text-yellow-500 font-medium text-xs leading-tight uppercase rounded hover:bg-black hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out float-right ${
                      todo.completed
